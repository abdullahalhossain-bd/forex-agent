...
if not groq_keys:
    ...
    # (404 model_not_found) — this diagnostic used the dead default, so
    # it would report a working key as broken. Match the safe default
    # used elsewhere (ai/ai_analyst.py, agents/master_analyst.py).
